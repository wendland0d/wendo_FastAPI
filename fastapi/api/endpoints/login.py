...
from ..schemas import LoginSchema, CurrentUserResponseModel, ErrorResponseModel, HTTPValidationError
...
@login_router.get('/logout', responses={
    ...
    tags=["auth"], summary="Выход из системы", description="При успешном выходе необходимо удалить установленные Cookies", operation_id="logout_logout_get")
